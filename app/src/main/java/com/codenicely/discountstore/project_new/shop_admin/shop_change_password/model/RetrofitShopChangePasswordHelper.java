...
import com.codenicely.discountstore.project_new.shop_admin.shop_change_password.api.ShopAdminChangePasswordApi;
import com.codenicely.discountstore.project_new.shop_admin.shop_change_password.data.ShopChangePasswordData;
...
public class RetrofitShopChangePasswordHelper implements ShopChangePasswordHelper {
	...
	@Override
	public void requestChangePassword(String shop_access_token, String old_password, String new_password, final ShopChangePasswordCallback shopChangePasswordCallback) {
		shopChangePasswordDataCall =shopAdminChangePasswordApi.requestChangePassword(shop_access_token,old_password,new_password);
