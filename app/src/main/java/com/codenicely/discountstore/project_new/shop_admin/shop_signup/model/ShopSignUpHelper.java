...
public interface ShopSignUpHelper {
    void requestSignUp(String shop_name, String shop_address, String shop_image, int shop_city_id,
                       String shop_mobile_number, String shop_email, String shop_password,
                       ShopSignUpRequestCallback shopSignUpRequestCallback);
}
