package com.codenicely.discountstore.project_new.helper.image_loader;
...
//        requestManager.load(url).crossFade().thumbnail(0.1f);
        ...
        requestManager.load(url).crossFade().listener(new RequestListener<String, GlideDrawable>() {
            @Override
