...
import com.codenicely.discountstore.project_new.shops.api.ShopsApi;
...
public class RetrofitShopProvider implements ShopProvider {
    ...
    @Override
    public void getShops(String access_token, int category_id, final OnShopsReceived onShopsReceived) {
