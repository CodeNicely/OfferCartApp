package com.codenicely.discountstore.project.login.presenter;

import android.util.Log;

import com.codenicely.discountstore.project.login.LoginCallback;
import com.codenicely.discountstore.project.login.models.LoginProvider;
import com.codenicely.discountstore.project.login.models.data.LoginData;
import com.codenicely.discountstore.project.login.view.LoginScreenView;
